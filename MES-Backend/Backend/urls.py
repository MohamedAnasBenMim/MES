...
from .views.user_email_verification import (send_user_verification_code,verify_user_and_create,)
from .views.profile_password_verification import (request_profile_password_change_code,verify_profile_password_change_code,)
...
from .views.idm_configuration import (
    idm_configurations,
    idm_configuration_detail,
)
...
urlpatterns = [
    ...
    path("api/operator-dashboard/",operator_dashboard,),
    ...
    path("api/profile-password/request-code/",request_profile_password_change_code,),
    path("api/profile-password/verify-code/",verify_profile_password_change_code,),
