...
from Backend.models import ActiveOperation, IonAPICredentials
    ...
    if request.method == "POST":
        try:
            ...
            operation = ActiveOperation(
                ...
                reference_operation_machine_type=data.get(
                    "ReferenceOperationMachineType", ""
                ),
                routing_quantity=data.get("RoutingQuantity", 0),
                planned_start_date=data.get("PlannedStartDate", ""),
                planned_finish_date=data.get("PlannedFinishDate", ""),
                reference_operation_work_center=data.get(
